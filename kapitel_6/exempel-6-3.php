...
<body>
    ...
    <form action="#" method="POST">
        ...
        <label for="Adress">Ange din adress här</label>
        ...
        <input id="Postort" class="form-control" type="text" name="postort" required> <br>
        <label for="Email">Epost</label>
        <input id="Email" class="form-control" type="email" name="epost" required> <br>
...
$postnrTrimmad = trim($postnr);
echo " <p>$postnrTrimmad</p>";
// Om vi har data 
