    ...
    <div class="kontainer">
        ...
        <nav>
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item"><a class="nav-link active" href="./sok.php">Sök efter kordinater och länder</a></li>
            </ul>
        </nav>
        ...
        if ($sökterm) {
            ...
            $sql = "SELECT * FROM lander WHERE kordinater LIKE '%$sökterm%' OR WHERE namn LIKE '%$sökterm%' OR WHERE kommentar LIKE '%$sökterm%'";
